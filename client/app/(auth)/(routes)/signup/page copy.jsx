...
function login() {
   return (
      <section className="h-screen">
         <main className="bg-[#2f4550] h-full w-full flex  justify-center items-center p-10 font-semibold transition-all duration-600">
            {/* medium to large screens */}
            <section className=" hidden sm:block w-[500px] lg:h-[650px] ">
